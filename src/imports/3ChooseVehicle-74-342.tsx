import svgPaths from "./svg-zeoe4zqx5r";
    ...
    <div className="relative shrink-0 w-full">
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-col gap-5 items-start justify-start leading-[0] not-italic px-5 py-0 relative w-full">
          <div className="font-['Poppins:Medium',_sans-serif] relative shrink-0 text-[#080a24] text-[48px] tracking-[-1.44px] w-full">
            <p className="leading-[1.2]">Select your language</p>
          </div>
          <div className="font-['Poppins:Regular',_sans-serif] relative shrink-0 text-[#2e2e2e] text-[24px] tracking-[-0.72px] w-full">
  ...
  return (
    <div className="bg-[#f6f6f6] relative rounded-[20px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center justify-center relative size-full">
        <div className="box-border content-stretch flex gap-2.5 items-center justify-center leading-[0] px-5 py-[30px] relative text-[#444343] w-full">
          <div className="basis-0 font-['Poppins:Regular',_sans-serif] grow min-h-px min-w-px not-italic relative shrink-0 text-[26px] tracking-[-0.78px]">
            <p className="leading-[normal]">English</p>
          </div>
          <div className="font-['SF_Pro:Regular',_sans-serif] font-normal relative shrink-0 text-[20px] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[normal] whitespace-pre">􀄥</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="relative shrink-0 w-full">
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-col gap-5 items-start justify-start px-5 py-0 relative w-full">
          <div className="font-['Poppins:Medium',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#080a24] text-[36px] tracking-[-1.08px] w-full">
    ...
    <div className="h-[20.924px] relative shrink-0 w-[122.054px]" data-name="Auto Layout Horizontal">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 123 21">
        <g id="Auto Layout Horizontal">
          ...
          <path d={svgPaths.p8f81700} fill="var(--fill-0, #170E2B)" id="Exclude_2" />
          <g id="Group">
