import svgPaths from "./svg-3su127jbik";
  ...
  return (
    <div className="content-stretch flex gap-[15.537px] items-center justify-start leading-[0] relative shrink-0 text-nowrap">
      ...
      <div className="flex flex-col font-['Poppins:Medium',_sans-serif] justify-center not-italic relative shrink-0 text-[41.875px] text-white tracking-[-1.675px]">
        <p className="leading-[79.17px] text-nowrap whitespace-pre">0.00</p>
      </div>
    </div>
  );
}
...
function Frame1410081217() {
  return (
    <div className="bg-[#0571dd] box-border content-stretch flex gap-[15px] h-[124.612px] items-center justify-center leading-[0] pl-[35.304px] pr-[30px] py-[35.306px] relative rounded-[42px] shrink-0 text-[49.158px] text-nowrap text-white">
      <div className="flex flex-col font-['Poppins:Medium',_sans-serif] justify-center not-italic relative shrink-0 tracking-[-1.9663px]">
        <p className="leading-[92.939px] text-nowrap whitespace-pre">Go Online</p>
      </div>
    ...
    <div className="bg-neutral-50 relative rounded-[12.889px] shrink-0 w-full">
      <div className="overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-[10.789px] items-start justify-start px-[16.184px] py-[9.667px] relative w-full">
          <Frame1410081602 />
          <div className="flex items-center justify-center relative shrink-0 w-full" style={{ "--transform-inner-width": "306.421875", "--transform-inner-height": "306.390625", height: "calc(1px * ((var(--transform-inner-width) * 1) + (var(--transform-inner-height) * 0)))" } as React.CSSProperties}>
