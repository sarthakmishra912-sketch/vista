import svgPaths from "./svg-l145m4g3nd";
    ...
    <div className="bg-[#fff9f3] relative rounded-[12.889px] shrink-0 w-full">
      <div className="overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-[10.789px] items-start justify-start px-[16.184px] py-[9.667px] relative w-full">
          <Frame1410081602 />
          <div className="flex items-center justify-center relative shrink-0 w-full" style={{ "--transform-inner-width": "1109.53125", "--transform-inner-height": "306.40625", height: "calc(1px * ((var(--transform-inner-width) * 1) + (var(--transform-inner-height) * 0)))" } as React.CSSProperties}>
...
function Frame1410081589() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[10.789px] grow items-start justify-center min-h-px min-w-px relative shrink-0">
      <div className="font-['Poppins:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#535353] text-[17.263px] w-full">
...
function Frame1410081216() {
  return (
    <div className="basis-0 grow h-[84.567px] min-h-px min-w-px relative rounded-[21.578px] shrink-0">
...
export default function Frame1410081582() {
  return (
    <div className="bg-[#fffefd] relative rounded-[21.578px] size-full">
      ...
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-col gap-[32.37px] items-start justify-start p-[21.578px] relative size-full">
          <Frame1410081607 />
          <Frame1410081599 />
        </div>
      </div>
