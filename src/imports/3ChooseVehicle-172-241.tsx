import svgPaths from "./svg-dw40ma5tdv";
...
function Frame1410081572() {
  return (
    <div className="absolute bg-[#3690d8] box-border content-stretch flex flex-col gap-[3.802px] items-center justify-center left-[58px] p-[14.256px] rounded-[24.235px] size-[38px] top-1.5">
      <div className="flex flex-col font-['SF_Pro:Medium',_sans-serif] font-[510] justify-center leading-[0] relative shrink-0 text-[22px] text-nowrap text-white" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Frame1410081570() {
  return (
    <div className="content-stretch flex gap-[15.537px] items-center justify-start leading-[0] relative shrink-0 text-nowrap">
      <div className="flex flex-col font-['SF_Pro:Medium',_sans-serif] font-[510] justify-center relative shrink-0 text-[#38a35f] text-[31.869px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[60.253px] text-nowrap whitespace-pre">􁑉</p>
      </div>
      <div className="flex flex-col font-['Poppins:Medium',_sans-serif] justify-center not-italic relative shrink-0 text-[41.875px] text-white tracking-[-1.675px]">
        <p className="leading-[79.17px] text-nowrap whitespace-pre">340.00</p>
      </div>
    </div>
  );
}
...
function Frame1410081215() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[6.917px] items-center justify-center p-[25.94px] relative rounded-[44.099px] shrink-0 size-[90px]">
      <div className="flex flex-col font-['SF_Pro:Medium',_sans-serif] font-[510] justify-center leading-[0] relative shrink-0 text-[#505050] text-[35.472px] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[67.065px] whitespace-pre">􀊫</p>
      </div>
    </div>
  );
}
...
function Frame1410081217() {
  return (
    <div className="bg-neutral-800 box-border content-stretch flex gap-[15px] h-[124.612px] items-center justify-center leading-[0] pl-[35.304px] pr-[30px] py-[35.306px] relative rounded-[42px] shrink-0 text-[49.158px] text-nowrap text-white">
      <div className="flex flex-col font-['Poppins:Medium',_sans-serif] justify-center not-italic relative shrink-0 tracking-[-1.9663px]">
        <p className="leading-[92.939px] text-nowrap whitespace-pre">Start Ride</p>
      </div>
      <div className="flex flex-col font-['SF_Pro:Medium',_sans-serif] font-[510] justify-center relative shrink-0" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[92.939px] text-nowrap whitespace-pre">􀷄</p>
      </div>
    </div>
  );
}
...
function Frame1410081580() {
  return (
    <div className="box-border content-stretch flex flex-col gap-2.5 items-start justify-start p-[10px] relative rounded-[49px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#040404] border-solid inset-0 pointer-events-none rounded-[49px]" />
      <Frame1410081217 />
    </div>
  );
}
...
function Frame1410081583() {
  return (
    <div className="content-stretch flex flex-col h-[399px] items-center justify-between relative shrink-0 w-[585px]">
      <Frame1410081587 />
      <Frame1410081580 />
    </div>
  );
  ...
  return (
    <div className="[grid-area:1_/_1] box-border content-stretch flex flex-col items-start justify-start ml-0 mt-0 relative">
      <div className="font-['Poppins:Medium',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#080a24] text-[36px] tracking-[-1.44px] w-full">
        <p className="leading-[normal]">You’re Offline</p>
      </div>
    </div>
  );
}
    ...
    <div className="content-stretch flex flex-col h-full items-start justify-between relative shrink-0">
      <div className="relative shrink-0 size-[3px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3 3">
          <circle cx="1.5" cy="1.5" fill="var(--fill-0, #505050)" id="Ellipse 300" r="1.5" />
        </svg>
      </div>
      <div className="relative shrink-0 size-[3px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3 3">
...
function Frame1410081576() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[46px]">
      ...
      <div className="h-[21.713px] relative shrink-0 w-[41.063px]" data-name="􀌇">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 42 22">
          <path d={svgPaths.ped12800} fill="var(--fill-0, #505050)" id="ô" />
        </svg>
      </div>
    </div>
  );
...
function Frame1410081574() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <div className="flex flex-col font-['SF_Pro:Medium',_sans-serif] font-[510] justify-center leading-[0] relative shrink-0 text-[#505050] text-[41.023px] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[77.56px] whitespace-pre">􀌆</p>
      </div>
      <Car1 />
      <Frame1410081576 />
    </div>
...
function ChooseYourRide() {
  return (
    <div className="content-stretch flex flex-col gap-2.5 items-center justify-center relative shrink-0 w-full" data-name="Choose your ride">
      <Frame1410081574 />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[7.552px] items-start justify-start leading-[0] not-italic relative shrink-0 w-full">
      ...
      <div className="font-['Poppins:Medium',_sans-serif] leading-[1.2] relative shrink-0 text-[0px] text-black w-[233.045px]">
        ...
        <p className="text-[#38a35f] text-[43.246px]">₹200.00</p>
      </div>
    </div>
  );
}

function Frame1410081603() {
  return (
    <div className="content-stretch flex flex-col gap-[15.342px] h-full items-center justify-center leading-[0] not-italic relative shrink-0 text-nowrap w-[134.681px]">
      <div className="font-['Poppins:Bold',_sans-serif] relative shrink-0 text-[#2e2e2e] text-[24.925px]">
        <p className="leading-[31.156px] text-nowrap whitespace-pre">1.5 km</p>
      </div>
      <div className="font-['Poppins:Regular',_sans-serif] relative shrink-0 text-[14.662px] text-black">
        <p className="leading-[18.328px] text-nowrap whitespace-pre">5 min away</p>
      </div>
    </div>
  );
}

function Frame1410081605() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      ...
      <div className="h-0 relative shrink-0 w-[27.615px]">
        <div className="absolute inset-[-0.77px_-2.78%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 2">
            <path d="M1 1H28.6152" id="Vector 47" opacity="0.2" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeWidth="1.53418" />
          </svg>
        </div>
      </div>
      <div className="flex flex-row items-center self-stretch">
...
function Frame1410081608() {
  return (
    <div className="content-stretch flex flex-col gap-[15.342px] h-full items-center justify-center leading-[0] not-italic relative shrink-0 text-nowrap w-[134.681px]">
      <div className="font-['Poppins:Bold',_sans-serif] relative shrink-0 text-[#1facbb] text-[26.081px]">
        <p className="leading-[18.328px] text-nowrap whitespace-pre">7.8 km</p>
      </div>
      <div className="font-['Poppins:Regular',_sans-serif] relative shrink-0 text-[14.662px] text-black">
        <p className="leading-[18.328px] text-nowrap whitespace-pre">12 min away</p>
      </div>
    </div>
  );
}

function Frame1410081609() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <div className="font-['Poppins:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[20.161px] text-black w-[118.132px]">
...
function Frame1410081601() {
  return (
    <div className="bg-neutral-50 relative rounded-[12.889px] shrink-0 w-full">
      <div className="overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-[10.789px] items-start justify-start px-[16.184px] py-[9.667px] relative w-full">
          <Frame1410081602 />
          <div className="flex items-center justify-center relative shrink-0 w-full" style={{ "--transform-inner-width": "306.453125", "--transform-inner-height": "306.40625", height: "calc(1px * ((var(--transform-inner-width) * 1) + (var(--transform-inner-height) * 0)))" } as React.CSSProperties}>
              ...
              <div className="h-[306.411px] relative w-full">
                <div className="absolute bottom-0 left-[-0.46px] right-[-0.46px] top-0">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2 307">
                    <path d="M1 0V306.411" id="Vector 44" stroke="var(--stroke-0, #E8E8E8)" strokeWidth="0.9164" />
                  </svg>
                </div>
              </div>
            </div>
  ...
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[10.789px] grow items-start justify-center min-h-px min-w-px relative shrink-0">
      <div className="font-['Poppins:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#2e2e2e] text-[17.263px] w-full">
        <p className="leading-[21.578px]">Safdarjung Enclave, Gali no.20</p>
      </div>
    </div>
  );
}

function Frame1410081586() {
  return (
...
function Frame1410081590() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[10.789px] grow items-start justify-center min-h-px min-w-px relative shrink-0">
      <div className="font-['Poppins:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#2e2e2e] text-[17.263px] w-full">
        <p className="leading-[21.578px]">Chandni Chowk, Metro Station gate 4</p>
      </div>
    </div>
  );
}

function Frame1410081591() {
  return (
      ...
      <div className="h-[0.005px] relative shrink-0 w-[21.578px]">
        <div className="absolute inset-[-8.08px_-5%_-7.8px_-5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 25 17">
            <path d={svgPaths.p27b8b880} fill="var(--stroke-0, black)" id="Vector 43" />
          </svg>
        </div>
      </div>
      <Frame1410081591 />
      ...
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute bottom-[-0.54px] left-0 right-0 top-[-0.54px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 339 2">
            <path d="M0 1H338.779" id="Vector 37" stroke="var(--stroke-0, black)" strokeOpacity="0.12" strokeWidth="1.07891" />
          </svg>
        </div>
      </div>
      <Frame1410081575 />
...
function Frame1410081223() {
  return (
    <div className="basis-0 bg-[#e3e3e3] grow h-[84.567px] min-h-px min-w-px relative rounded-[21.578px] shrink-0">
      <div className="flex flex-row items-center justify-center relative size-full">
        <div className="box-border content-stretch flex gap-[16.184px] h-[84.567px] items-center justify-center leading-[0] pl-[23.959px] pr-[20.359px] py-[23.96px] relative text-nowrap text-white w-full">
          <div className="flex flex-col font-['Poppins:Medium',_sans-serif] justify-center not-italic relative shrink-0 text-[31.626px] tracking-[-1.265px]">
            <p className="leading-[59.793px] text-nowrap whitespace-pre">Accept Ride</p>
          </div>
          <div className="flex flex-col font-['SF_Pro:Medium',_sans-serif] font-[510] justify-center relative shrink-0 text-[33.36px]" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[63.072px] text-nowrap whitespace-pre">􀷞</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame1410081544() {
  return (
    <div className="box-border content-stretch flex flex-col h-[631.164px] items-start justify-between p-[21.578px] relative rounded-[21.578px] shrink-0 w-[381.935px]">
      <div aria-hidden="true" className="absolute border-[#7b7b7b] border-[2.158px] border-solid inset-0 pointer-events-none rounded-[21.578px]" />
      <Frame1410081607 />
      <Frame1410081606 />
    </div>
  );
...
function Frame1410081224() {
  return (
    <div className="content-stretch flex flex-col gap-[7.552px] items-start justify-start leading-[0] not-italic relative shrink-0 w-full">
      ...
      <div className="font-['Poppins:Medium',_sans-serif] leading-[1.2] relative shrink-0 text-[0px] text-black w-[233.045px]">
        <p className="mb-0 text-[26.428px]">Earning</p>
        <p className="text-[#c06821] text-[43.246px]">₹2500.00</p>
      </div>
    </div>
  );
}

function Frame1410081614() {
  return (
    <div className="content-stretch flex flex-col gap-[15.342px] h-full items-center justify-center leading-[0] not-italic relative shrink-0 text-nowrap w-[134.681px]">
      <div className="font-['Poppins:Bold',_sans-serif] relative shrink-0 text-[#2e2e2e] text-[24.925px]">
        <p className="leading-[31.156px] text-nowrap whitespace-pre">15.5 km</p>
      </div>
      <div className="font-['Poppins:Regular',_sans-serif] relative shrink-0 text-[14.662px] text-black">
        <p className="leading-[18.328px] text-nowrap whitespace-pre">5 min away</p>
      </div>
...
function Frame1410081617() {
  return (
    <div className="content-stretch flex flex-col gap-[15.342px] h-full items-center justify-center leading-[0] not-italic relative shrink-0 text-nowrap w-[134.681px]">
      <div className="font-['Poppins:Bold',_sans-serif] relative shrink-0 text-[#e2ab7e] text-[26.081px]">
        <p className="leading-[18.328px] text-nowrap whitespace-pre">27.8 km</p>
      </div>
      <div className="font-['Poppins:Regular',_sans-serif] relative shrink-0 text-[14.662px] text-black">
        <p className="leading-[18.328px] text-nowrap whitespace-pre">12 min away</p>
      </div>
...
function Frame1410081620() {
  return (
    <div className="bg-[#fff9f3] relative rounded-[12.889px] shrink-0 w-full">
      <div className="overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-[10.789px] items-start justify-start px-[16.184px] py-[9.667px] relative w-full">
          <Frame1410081616 />
          <div className="flex items-center justify-center relative shrink-0 w-full" style={{ "--transform-inner-width": "306.453125", "--transform-inner-height": "306.40625", height: "calc(1px * ((var(--transform-inner-width) * 1) + (var(--transform-inner-height) * 0)))" } as React.CSSProperties}>
  ...
  return (
    <div className="basis-0 bg-[#e3e3e3] grow h-[84.567px] min-h-px min-w-px relative rounded-[21.578px] shrink-0">
      <div className="flex flex-row items-center justify-center relative size-full">
        <div className="box-border content-stretch flex gap-[16.184px] h-[84.567px] items-center justify-center leading-[0] pl-[23.959px] pr-[20.359px] py-[23.96px] relative text-nowrap text-white w-full">
          <div className="flex flex-col font-['Poppins:Medium',_sans-serif] justify-center not-italic relative shrink-0 text-[31.626px] tracking-[-1.265px]">
            <p className="leading-[59.793px] text-nowrap whitespace-pre">Golden Ride</p>
          </div>
          <div className="flex flex-col font-['SF_Pro:Medium',_sans-serif] font-[510] justify-center relative shrink-0 text-[22.509px]" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[42.557px] text-nowrap whitespace-pre">􀋃</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame1410081628() {
  return (
    <div className="bg-[#fffefd] box-border content-stretch flex flex-col h-[631.164px] items-start justify-between p-[21.578px] relative rounded-[21.578px] shrink-0 w-[381.935px]">
      <div aria-hidden="true" className="absolute border-[#c06821] border-[2.158px] border-solid inset-0 pointer-events-none rounded-[21.578px]" />
      <Frame1410081626 />
      <Frame1410081627 />
    </div>
  );
...
function Frame1410081228() {
  return (
    <div className="content-stretch flex flex-col gap-[7.552px] items-start justify-start leading-[0] not-italic relative shrink-0">
      <div className="font-['Poppins:Regular',_sans-serif] relative shrink-0 text-[#656565] text-[19.42px] text-nowrap">
        <p className="leading-[normal] whitespace-pre">Bike Rescue</p>
      </div>
      <div className="font-['Poppins:Medium',_sans-serif] relative shrink-0 text-[30.21px] text-black w-[195.283px]">
        <p className="leading-[normal]">₹200.00 / hr.</p>
      </div>
    </div>
  );
}
...
function Frame1410081229() {
  return (
    <div className="bg-[#38a35f] box-border content-stretch flex gap-[10.18px] h-[84.567px] items-center justify-center leading-[0] pl-[23.959px] pr-[20.359px] py-[23.96px] relative rounded-[28.503px] shrink-0 text-[33.36px] text-nowrap text-white">
      <div className="flex flex-col font-['Poppins:Medium',_sans-serif] justify-center not-italic relative shrink-0 tracking-[-1.3344px]">
        <p className="leading-[63.072px] text-nowrap whitespace-pre">Accept Ride</p>
      </div>
      <div className="flex flex-col font-['SF_Pro:Medium',_sans-serif] font-[510] justify-center relative shrink-0" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[63.072px] text-nowrap whitespace-pre">􀷞</p>
      </div>
...
function Frame1410081220() {
  return (
    <div className="content-stretch flex flex-col gap-[20.499px] items-start justify-start relative shrink-0 w-full">
      <Frame1410081230 />
    </div>
  );
}
...
function Frame1410081221() {
  return (
    <div className="content-stretch flex flex-col gap-[19.42px] items-center justify-start relative shrink-0 w-full">
      <Frame1410081220 />
    </div>
  );
}

function Frame1410081629() {
  return (
    <div className="content-stretch flex font-['Poppins:Medium',_sans-serif] gap-[222.256px] items-start justify-start leading-[0] not-italic relative shrink-0 text-[28.052px] text-black text-nowrap w-full">
      <div className="relative shrink-0">
        <p className="leading-[normal] text-nowrap whitespace-pre">Pickup</p>
      </div>
      <div className="relative shrink-0">
...
function Frame1410081630() {
  return (
    <div className="content-stretch flex flex-col gap-[10.789px] items-start justify-center relative shrink-0">
      <div className="font-['Poppins:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#2e2e2e] text-[17.263px] w-[176.942px]">
        <p className="leading-[21.578px]">Safdarjung Enclave, Gali no.20</p>
      </div>
    </div>
  );
...
function Frame1410081634() {
  return (
    <div className="content-stretch flex gap-[21.578px] items-center justify-start relative shrink-0 w-full">
      ...
      <div className="h-[0.413px] relative shrink-0 w-[73.366px]">
        <div className="absolute inset-[-1903.2%_-1.47%_-1846.53%_-1.47%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 77 17">
            <path d={svgPaths.p2f42dd00} fill="var(--stroke-0, black)" id="Vector 43" />
          </svg>
        </div>
      </div>
      <Frame1410081633 />
...
function Frame1410081231() {
  return (
    <div className="basis-0 bg-[#f9f3eb] grow h-[84.567px] min-h-px min-w-px relative rounded-[21.578px] shrink-0">
      <div className="flex flex-row items-center justify-center relative size-full">
        <div className="box-border content-stretch flex gap-[16.184px] h-[84.567px] items-center justify-center leading-[0] pl-[23.959px] pr-[20.359px] py-[23.96px] relative text-nowrap text-white w-full">
          <div className="flex flex-col font-['Poppins:Medium',_sans-serif] justify-center not-italic relative shrink-0 text-[31.626px] tracking-[-1.265px]">
            <p className="leading-[59.793px] text-nowrap whitespace-pre">Accept Ride</p>
...
function Frame1410081636() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[21.578px] items-start justify-start opacity-20 p-[21.578px] relative rounded-[21.578px] shrink-0 w-[559.956px]">
      <div aria-hidden="true" className="absolute border-[#505050] border-[2.158px] border-solid inset-0 pointer-events-none rounded-[21.578px]" />
      <Frame1410081221 />
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute bottom-[-0.54px] left-0 right-0 top-[-0.54px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 517 2">
            <path d="M0 1H516.799" id="Vector 37" stroke="var(--stroke-0, black)" strokeOpacity="0.12" strokeWidth="1.07891" />
          </svg>
        </div>
      </div>
      <Frame1410081600 />
...
function Frame1410081593() {
  return (
    <div className="content-stretch flex gap-[21.578px] items-start justify-start relative shrink-0 w-[1164.15px]">
      <Frame1410081544 />
      <Frame1410081628 />
      <Frame1410081636 />
    </div>
...
function Cross() {
  return (
    <div className="relative shrink-0 size-[18px]" data-name="Cross">
...
function Frame1410081578() {
  return (
    <div className="content-stretch flex flex-col gap-2.5 items-start justify-start relative shrink-0 w-full">
      <Frame1410081638 />
      <div className="font-['Poppins:Medium',_sans-serif] leading-[0] min-w-full not-italic relative shrink-0 text-[28px] text-black" style={{ width: "min-content" }}>
...
export default function Component3ChooseVehicle() {
  return (
    <div className="bg-[position:50%_50%,_0%_0%] bg-size-[cover,auto] bg-white box-border content-stretch flex flex-col gap-5 items-center justify-start pb-0 pt-20 px-0 relative size-full" data-name="3. Choose Vehicle" style={{ backgroundImage: `url('${img3ChooseVehicle}')` }}>
      <Frame1410081584 />
    </div>
  );
}